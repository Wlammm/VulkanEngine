...
public:
    ...
    static void DefaultTheme()
    {
        ...
        colors[ImGuiCol_Header]                 = ImVec4(0.15f, 0.23f, 0.32f, 1.00f);
        colors[ImGuiCol_HeaderHovered]          = ImVec4(0.21f, 0.35f, 0.50f, 1.00f);
        colors[ImGuiCol_HeaderActive]           = ImVec4(0.24f, 0.42f, 0.63f, 1.00f);
        ...
        colors[ImGuiCol_Tab]                    = ImVec4(0.15f, 0.23f, 0.32f, 1.00f);
        colors[ImGuiCol_TabHovered]             = ImVec4(0.21f, 0.35f, 0.50f, 1.00f);
        colors[ImGuiCol_TabActive]              = ImVec4(0.24f, 0.42f, 0.63f, 1.00f);
