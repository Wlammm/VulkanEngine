...
public:
    static vk::DescriptorSet CreateDescriptorSetForTexture(SharedPtr<Texture> inTexture)
    {
        ...
        vk::DescriptorSet descriptorSet = ImGui_ImplVulkan_AddTexture(VulkanUtils::GetSampler(SamplerMode::LinearClamp), inTexture->GetImage()->GetImageView(), VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL);
