...
VulkanIndexBuffer::VulkanIndexBuffer(const List<uint>& inIndices)
{
	...
	VulkanBuffer* stagingBuffer = VulkanAllocator::AllocateBuffer_TS("Index staging buffer", stagingCreateInfo, VMA_MEMORY_USAGE_AUTO, true);
	...
	myBuffer = VulkanAllocator::AllocateBuffer_TS("IndexBuffer", createInfo, VMA_MEMORY_USAGE_AUTO);
