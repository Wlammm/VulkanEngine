...
public:
    ReflectedField();
    ReflectedField(const std::string& inFieldName, const std::string& inFieldType, const uint32_t inByteOffset, const std::vector<std::string>& inMetadata, bool inIsPointer, bool inIsReference);
