...
{ 
	...
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<Skeleton::Bone>("Skeleton::Bone"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<std::thread>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<std::thread>("std::thread"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<IAssetContainer *>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<IAssetContainer *>("IAssetContainer *"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<vk::Framebuffer>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<vk::Framebuffer>("vk::Framebuffer"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<Vertex>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<Vertex>("Vertex"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<unsigned int>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<unsigned int>("unsigned int"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<Mesh *>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<Mesh *>("Mesh *"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<Filewatcher::CallbackHandle>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<Filewatcher::CallbackHandle>("Filewatcher::CallbackHandle"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<std::function<void ()>>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<std::function<void ()>>("std::function<void ()>"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<unsigned char>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<unsigned char>("unsigned char"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<GameObject *>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<GameObject *>("GameObject *"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<IComponentArray *>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<IComponentArray *>("IComponentArray *"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<Material *>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<Material *>("Material *"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<TransformComponent *>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<TransformComponent *>("TransformComponent *"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<EventObserver *>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<EventObserver *>("EventObserver *"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<Delegate<void (physx::PxPhysics *, physx::PxScene *)>>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<Delegate<void (physx::PxPhysics *, physx::PxScene *)>>("Delegate<void (physx::PxPhysics *, physx::PxScene *)>"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<std::basic_string<char>>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<std::basic_string<char>>("std::basic_string<char>"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<MethodArgument>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<MethodArgument>("MethodArgument"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<const Class *>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<const Class *>("const Class *"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<Field>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<Field>("Field"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<Method>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<Method>("Method"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<Class *>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<Class *>("Class *"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<IndexBufferHandle *>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<IndexBufferHandle *>("IndexBufferHandle *"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<IndexBufferData>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<IndexBufferData>("IndexBufferData"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<VertexBufferHandle *>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<VertexBufferHandle *>("VertexBufferHandle *"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<VertexBufferData>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<VertexBufferData>("VertexBufferData"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<const char *>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<const char *>("const char *"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<vk::QueueFamilyProperties>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<vk::QueueFamilyProperties>("vk::QueueFamilyProperties"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<vk::Fence>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<vk::Fence>("vk::Fence"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<vk::Semaphore>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<vk::Semaphore>("vk::Semaphore"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<vk::Image>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<vk::Image>("vk::Image"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<vk::ImageView>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<vk::ImageView>("vk::ImageView"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<vk::CommandBuffer>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<vk::CommandBuffer>("vk::CommandBuffer"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<EditorWindow *>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<EditorWindow *>("EditorWindow *"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<EditorSystem *>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<EditorSystem *>("EditorSystem *"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<const Method *>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<const Method *>("const Method *"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<std::filesystem::path>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<std::filesystem::path>("std::filesystem::path"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<ContentBrowserItem>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<ContentBrowserItem>("ContentBrowserItem"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<List<vk::DescriptorSet>>();
	currentClass->AddBaseClass(reflectionSystem.GetMutableClass<ICollectable>());
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<vk::DescriptorSet>("vk::DescriptorSet"));
}
{ 
	Class* currentClass = reflectionSystem.GetMutableClass<IsCopyable<int>>();
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<int>("int"));
}
{ 
...
{ 
	...
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<void>("void"));
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
...
{ 
	...
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<void (Component *)>("void (Component *)"));
}
{ 
...
{ 
	...
	currentClass->AddTemplateArgument(reflectionSystem.GetOrCreateClass<void *(void *, const List<void *> &)>("void *(void *, const List<void *> &)"));
}
{ 
...
{ 
	...
	{
		Field& currentField = currentClass->AddField(Field("myTemplateArguments", 176, reflectionSystem.GetOrCreateClass<List<const Class *>>("List<const Class *>")));
	}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
...
Class* instance = static_cast<Class*>(inInstance);
const Class * arg0 = (const Class*)inArguments[0];
instance->AddTemplateArgument(arg0);
return nullptr;
});
List<MethodArgument> arguments{};
