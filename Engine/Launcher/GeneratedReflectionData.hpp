	...
	static void RegisterReflectionData(Engine& inEngine)
	{
		...
		// Add all fields & add base classes.
		{
			...
			}
			{
				...
				currentClass->AddField(Field("myFrameIndex", offsetof(Engine, myFrameIndex), reflectionSystem.GetClass<uint>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myIsRunning", offsetof(Engine, myIsRunning), reflectionSystem.GetClass<bool>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myEngineProperties", offsetof(Engine, myEngineProperties), reflectionSystem.GetClass<EngineProperties>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("mySystemManager", offsetof(Engine, mySystemManager), reflectionSystem.GetClass<class SystemManager<System> *>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myPostMaster", offsetof(Engine, myPostMaster), reflectionSystem.GetClass<class EventHandler *>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myThreadPool", offsetof(Engine, myThreadPool), reflectionSystem.GetClass<class ThreadPool *>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myFilewatcher", offsetof(Engine, myFilewatcher), reflectionSystem.GetClass<class Filewatcher *>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myWindowHandler", offsetof(Engine, myWindowHandler), reflectionSystem.GetClass<class WindowHandler *>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myVulkanContext", offsetof(Engine, myVulkanContext), reflectionSystem.GetClass<class VulkanContext *>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myAssetRegistry", offsetof(Engine, myAssetRegistry), reflectionSystem.GetClass<class AssetRegistry *>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myWorld", offsetof(Engine, myWorld), reflectionSystem.GetClass<class World *>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myExternalTickFunction", offsetof(Engine, myExternalTickFunction), reflectionSystem.GetClass<std::function<void ()>>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				// Base classes are not implemented yet.
			}
			{
			...
			}
			{
				...
				currentClass->AddField(Field("myPath", offsetof(Asset, myPath), reflectionSystem.GetClass<std::filesystem::path>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myIsValid", offsetof(Asset, myIsValid), reflectionSystem.GetClass<bool>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
			...
			}
			{
				...
				currentClass->AddField(Field("myThreads", offsetof(ThreadPool, myThreads), reflectionSystem.GetClass<int>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myLookingForTaskMutex", offsetof(ThreadPool, myLookingForTaskMutex), reflectionSystem.GetClass<std::mutex>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myWaitingForTaskCondition", offsetof(ThreadPool, myWaitingForTaskCondition), reflectionSystem.GetClass<std::condition_variable>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myShouldExit", offsetof(ThreadPool, myShouldExit), reflectionSystem.GetClass<std::atomic_bool>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myTasks", offsetof(ThreadPool, myTasks), reflectionSystem.GetClass<int>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				// Base classes are not implemented yet.
			}
			{
			...
			}
			{
				...
				currentClass->AddField(Field("myIsUsingGPUDrivenRendering", offsetof(RenderSystem, myIsUsingGPUDrivenRendering), reflectionSystem.GetClass<bool>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myCopyPipeline", offsetof(RenderSystem, myCopyPipeline), reflectionSystem.GetClass<class FullscreenPipeline *>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myDebugPipeline", offsetof(RenderSystem, myDebugPipeline), reflectionSystem.GetClass<class DebugPipeline *>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myGDRPipeline", offsetof(RenderSystem, myGDRPipeline), reflectionSystem.GetClass<class GDRPipeline *>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("mySkyboxPipeline", offsetof(RenderSystem, mySkyboxPipeline), reflectionSystem.GetClass<class SkyboxPipeline *>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myRenderPass", offsetof(RenderSystem, myRenderPass), reflectionSystem.GetClass<vk::RenderPass>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myCopyToSwapchainRenderPass", offsetof(RenderSystem, myCopyToSwapchainRenderPass), reflectionSystem.GetClass<vk::RenderPass>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myVkFrameBuffer", offsetof(RenderSystem, myVkFrameBuffer), reflectionSystem.GetClass<vk::Framebuffer>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myCopyToSwapchainFrameBuffers", offsetof(RenderSystem, myCopyToSwapchainFrameBuffers), reflectionSystem.GetClass<int>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myClearValues", offsetof(RenderSystem, myClearValues), reflectionSystem.GetClass<vk::ClearValue[2]>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myDepthBuffer", offsetof(RenderSystem, myDepthBuffer), reflectionSystem.GetClass<class VulkanImage *>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myRenderTexture", offsetof(RenderSystem, myRenderTexture), reflectionSystem.GetClass<class VulkanImage *>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myResolvedRenderTexture", offsetof(RenderSystem, myResolvedRenderTexture), reflectionSystem.GetClass<class VulkanImage *>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
			...
			}
			{
				...
				currentClass->AddField(Field("OnShaderRecompiled", offsetof(Shader, OnShaderRecompiled), reflectionSystem.GetClass<MulticastDelegate<void ()>>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
			...
			}
			{
				...
				currentClass->AddField(Field("myImage", offsetof(Texture, myImage), reflectionSystem.GetClass<VulkanImage *>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
			...
			}
			{
				...
				currentClass->AddField(Field("OnComponentAdded", offsetof(GameObject, OnComponentAdded), reflectionSystem.GetClass<MulticastDelegate<void (Component *)>>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("OnComponentRemoved", offsetof(GameObject, OnComponentRemoved), reflectionSystem.GetClass<MulticastDelegate<void (Component *)>>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
			...
			}
			{
				...
				currentClass->AddField(Field("myShape", offsetof(ColliderComponent, myShape), reflectionSystem.GetClass<physx::PxShape *>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myActor", offsetof(ColliderComponent, myActor), reflectionSystem.GetClass<physx::PxRigidStatic *>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
			...
			}
			{
				...
				currentClass->AddField(Field("mySeed", offsetof(Heightfield, mySeed), reflectionSystem.GetClass<int>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myPerlinNoise", offsetof(Heightfield, myPerlinNoise), reflectionSystem.GetClass<siv::BasicPerlinNoise<float>>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				// Base classes are not implemented yet.
			}
			{
			...
			}
			{
				...
				currentClass->AddField(Field("OnPositionChanged", offsetof(TransformComponent, OnPositionChanged), reflectionSystem.GetClass<MulticastDelegate<void ()>>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("OnRotationChanged", offsetof(TransformComponent, OnRotationChanged), reflectionSystem.GetClass<MulticastDelegate<void ()>>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("OnScaleChanged", offsetof(TransformComponent, OnScaleChanged), reflectionSystem.GetClass<MulticastDelegate<void ()>>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
			...
			}
			{
				...
				currentClass->AddField(Field("myOffset", offsetof(Field, myOffset), reflectionSystem.GetClass<uint>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
			...
			}
			{
				...
				currentClass->AddField(Field("myPrePass", offsetof(GDRPipeline, myPrePass), reflectionSystem.GetClass<ComputePassResources>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myCullPass", offsetof(GDRPipeline, myCullPass), reflectionSystem.GetClass<ComputePassResources>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
			...
			}
			{
				...
				currentClass->AddField(Field("myVertexBuffer", offsetof(Mesh, myVertexBuffer), reflectionSystem.GetClass<VertexBufferHandle *>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myIndexBuffer", offsetof(Mesh, myIndexBuffer), reflectionSystem.GetClass<IndexBufferHandle *>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("mySphereBounds", offsetof(Mesh, mySphereBounds), reflectionSystem.GetClass<glm::vec4>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myHandle", offsetof(Mesh, myHandle), reflectionSystem.GetClass<uint>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
			...
			}
			{
				...
				currentClass->AddField(Field("myDescriptorPool", offsetof(TextureSystem, myDescriptorPool), reflectionSystem.GetClass<vk::DescriptorPool>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				// Base classes are not implemented yet.
			}
			{
			...
			}
			{
				...
				currentClass->AddField(Field("OnBufferResized", offsetof(ResizableBuffer, OnBufferResized), reflectionSystem.GetClass<MulticastDelegate<void ()>>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
			...
			}
			{
				...
				currentClass->AddField(Field("m_AftermathFlags", offsetof(NvidiaAftermathTracker, m_AftermathFlags), reflectionSystem.GetClass<const uint32_t>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				// Base classes are not implemented yet.
			}
			{
				Class* currentClass = reflectionSystem.GetMutableClass<VulkanContext>();
				currentClass->AddField(Field("myVulkanInstance", offsetof(VulkanContext, myVulkanInstance), reflectionSystem.GetClass<vk::Instance>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myDebugMessenger", offsetof(VulkanContext, myDebugMessenger), reflectionSystem.GetClass<vk::DebugUtilsMessengerEXT>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myPipelineCache", offsetof(VulkanContext, myPipelineCache), reflectionSystem.GetClass<vk::PipelineCache>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myPhysicalDevice", offsetof(VulkanContext, myPhysicalDevice), reflectionSystem.GetClass<class VulkanPhysicalDevice *>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myDevice", offsetof(VulkanContext, myDevice), reflectionSystem.GetClass<class VulkanDevice *>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myAllocator", offsetof(VulkanContext, myAllocator), reflectionSystem.GetClass<class VulkanAllocator *>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("mySwapChain", offsetof(VulkanContext, mySwapChain), reflectionSystem.GetClass<class VulkanSwapChain *>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("markerMap", offsetof(VulkanContext, markerMap), reflectionSystem.GetClass<NvidiaAftermathTracker::MarkerMap>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myNvidiaAftermathDebugger", offsetof(VulkanContext, myNvidiaAftermathDebugger), reflectionSystem.GetClass<class NvidiaAftermathTracker *>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myDescriptorPool", offsetof(VulkanContext, myDescriptorPool), reflectionSystem.GetClass<vk::DescriptorPool>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myExtensions", offsetof(VulkanContext, myExtensions), reflectionSystem.GetClass<const int>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myLayers", offsetof(VulkanContext, myLayers), reflectionSystem.GetClass<const int>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				// Base classes are not implemented yet.
			}
			{
			...
			}
			{
				...
				currentClass->AddField(Field("myHWND", offsetof(WindowHandler, myHWND), reflectionSystem.GetClass<HWND>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				currentClass->AddField(Field("myHInstance", offsetof(WindowHandler, myHInstance), reflectionSystem.GetClass<HINSTANCE>(), false, false /* THESE 2 ARE TO BE IMPLEMENTED LATER*/));
				// Base classes are not implemented yet.
			}
			{
