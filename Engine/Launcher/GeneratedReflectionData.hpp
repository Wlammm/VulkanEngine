...
{ 
	...
	{
		Field& currentField = currentClass->AddField(Field("myShouldTickComponents", 104, ReflectionSystem::GetOrCreateType<bool>("bool"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myEditorCamera", 112, ReflectionSystem::GetOrCreateType<EditorCameraActor>("EditorCameraActor"), true, false));
	}
...
{ 
	...
	{
		Field& currentField = currentClass->AddField(Field("myVertices", 0, ReflectionSystem::GetOrCreateType<List<Vertex>>("List<Vertex>"), false, false));
		currentField.AddMetadata(R"delim(SerializeField)delim");
	}
	{
		Field& currentField = currentClass->AddField(Field("myIndices", 24, ReflectionSystem::GetOrCreateType<List<unsigned int>>("List<unsigned int>"), false, false));
		currentField.AddMetadata(R"delim(SerializeField)delim");
	}
	{
		Field& currentField = currentClass->AddField(Field("mySphereCenterBounds", 48, ReflectionSystem::GetOrCreateType<glm::vec<4, float>>("glm::vec<4, float>"), false, false));
		currentField.AddMetadata(R"delim(SerializeField)delim");
	}
	{
		Field& currentField = currentClass->AddField(Field("myStagingVertexBuffer", 64, ReflectionSystem::GetOrCreateType<VulkanBuffer>("VulkanBuffer"), true, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myStagingIndexBuffer", 72, ReflectionSystem::GetOrCreateType<VulkanBuffer>("VulkanBuffer"), true, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myAlbedoPath", 80, ReflectionSystem::GetOrCreateType<std::basic_string<char>>("std::basic_string<char>"), false, false));
		currentField.AddMetadata(R"delim(SerializeField)delim");
	}
	{
		Field& currentField = currentClass->AddField(Field("myNormalPath", 120, ReflectionSystem::GetOrCreateType<std::basic_string<char>>("std::basic_string<char>"), false, false));
		currentField.AddMetadata(R"delim(SerializeField)delim");
	}
	{
		Field& currentField = currentClass->AddField(Field("myMaterialPath", 160, ReflectionSystem::GetOrCreateType<std::basic_string<char>>("std::basic_string<char>"), false, false));
		currentField.AddMetadata(R"delim(SerializeField)delim");
	}
}
{ 
	...
	{
		Field& currentField = currentClass->AddField(Field("mySourceFilePath", 0, ReflectionSystem::GetOrCreateType<std::basic_string<wchar_t>>("std::basic_string<wchar_t>"), false, false));
		currentField.AddMetadata(R"delim(SerializeField)delim");
	}
	{
		Field& currentField = currentClass->AddField(Field("myLastCachedWriteTime", 40, ReflectionSystem::GetOrCreateType<std::chrono::time_point<std::filesystem::_File_time_clock>>("std::chrono::time_point<std::filesystem::_File_time_clock>"), false, false));
		currentField.AddMetadata(R"delim(SerializeField)delim");
	}
	{
		Field& currentField = currentClass->AddField(Field("myMeshDatas", 48, ReflectionSystem::GetOrCreateType<List<SerializationMeshData>>("List<SerializationMeshData>"), false, false));
		currentField.AddMetadata(R"delim(SerializeField)delim");
	}
}
{ 
...
{ 
	...
	{
		Field& currentField = currentClass->AddField(Field("mySourceFile", 0, ReflectionSystem::GetOrCreateType<std::filesystem::path>("std::filesystem::path"), false, false));
		currentField.AddMetadata(R"delim(SerializeField)delim");
	}
	{
		Field& currentField = currentClass->AddField(Field("myLastSourceWriteTime", 40, ReflectionSystem::GetOrCreateType<std::chrono::time_point<std::filesystem::_File_time_clock>>("std::chrono::time_point<std::filesystem::_File_time_clock>"), false, false));
		currentField.AddMetadata(R"delim(SerializeField)delim");
	}
	{
		Field& currentField = currentClass->AddField(Field("myWidth", 48, ReflectionSystem::GetOrCreateType<int>("int"), false, false));
		currentField.AddMetadata(R"delim(SerializeField)delim");
	}
	{
		Field& currentField = currentClass->AddField(Field("myHeight", 52, ReflectionSystem::GetOrCreateType<int>("int"), false, false));
		currentField.AddMetadata(R"delim(SerializeField)delim");
	}
	{
		Field& currentField = currentClass->AddField(Field("myChannels", 56, ReflectionSystem::GetOrCreateType<int>("int"), false, false));
		currentField.AddMetadata(R"delim(SerializeField)delim");
	}
	{
		Field& currentField = currentClass->AddField(Field("myNumMipLevels", 60, ReflectionSystem::GetOrCreateType<unsigned int>("unsigned int"), false, false));
		currentField.AddMetadata(R"delim(SerializeField)delim");
	}
	{
		Field& currentField = currentClass->AddField(Field("myPixelData", 64, ReflectionSystem::GetOrCreateType<List<unsigned char>>("List<unsigned char>"), false, false));
		currentField.AddMetadata(R"delim(SerializeField)delim");
	}
}
{ 
...
{ 
	...
	{
		Field& currentField = currentClass->AddField(Field("myShouldWriteDepth", 112, ReflectionSystem::GetOrCreateType<bool>("bool"), false, false));
	}
	currentClass->AddBaseType(ReflectionSystem::GetMutableType<Component>());
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
...
{ 
	...
	{
		Field& currentField = currentClass->AddField(Field("SomeFloat", 0, ReflectionSystem::GetOrCreateType<float>("float"), false, false));
		currentField.AddMetadata(R"delim(SerializeField)delim");
	}
	{
		Field& currentField = currentClass->AddField(Field("SomeField", 4, ReflectionSystem::GetOrCreateType<int>("int"), false, false));
		currentField.AddMetadata(R"delim(SerializeField)delim");
	}
}
{ 
...
{ 
	...
	{
		Field& currentField = currentClass->AddField(Field("myPosition", 0, ReflectionSystem::GetOrCreateType<glm::vec<3, float>>("glm::vec<3, float>"), false, false));
		currentField.AddMetadata(R"delim(SerializeField)delim");
	}
	{
		Field& currentField = currentClass->AddField(Field("myColor", 12, ReflectionSystem::GetOrCreateType<int>("int"), false, false));
		currentField.AddMetadata(R"delim(SerializeField)delim");
	}
	{
		Field& currentField = currentClass->AddField(Field("myNormal", 16, ReflectionSystem::GetOrCreateType<glm::vec<3, float>>("glm::vec<3, float>"), false, false));
		currentField.AddMetadata(R"delim(SerializeField)delim");
	}
	{
		Field& currentField = currentClass->AddField(Field("myTangents", 28, ReflectionSystem::GetOrCreateType<glm::vec<3, float>>("glm::vec<3, float>"), false, false));
		currentField.AddMetadata(R"delim(SerializeField)delim");
	}
	{
		Field& currentField = currentClass->AddField(Field("myBinormals", 40, ReflectionSystem::GetOrCreateType<glm::vec<3, float>>("glm::vec<3, float>"), false, false));
		currentField.AddMetadata(R"delim(SerializeField)delim");
	}
	{
		Field& currentField = currentClass->AddField(Field("myTexCoords", 52, ReflectionSystem::GetOrCreateType<glm::vec<2, float>[2]>("glm::vec<2, float>[2]"), false, false));
		currentField.AddMetadata(R"delim(SerializeField)delim");
	}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
...
{ 
	...
	{
		Field& currentField = currentClass->AddField(Field("myActors", 40, ReflectionSystem::GetOrCreateType<List<UniquePtr<Actor>>>("List<UniquePtr<Actor>>"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myActorsToDelete", 64, ReflectionSystem::GetOrCreateType<List<Actor *>>("List<Actor *>"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myDirectionalLightActor", 88, ReflectionSystem::GetOrCreateType<DirectionalLightActor>("DirectionalLightActor"), true, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myMainCamera", 96, ReflectionSystem::GetOrCreateType<CameraComponent>("CameraComponent"), true, false));
	}
