...
#include "../Editor/EditorSystem/FoliagePaintTool.h"
#include "../Editor/../External/PerlinNoise/PerlinNoise.hpp"
...
#include "../Editor/Windows/FoliagePaintWindow.h"
...
#include "../Engine/Rendering/RenderingPasses/GraphicsPasses/PrePass.h"
...
#include "../Engine/Rendering/RenderingPasses/GraphicsPasses/FoliagePass.h"
#include "../Engine/Rendering/RenderingPasses/ComputePasses/FoliageCullPass.h"
#include "../Engine/Rendering/RenderingPasses/ComputePasses/FoliagePrePass.h"
...
ReflectionSystem::AddType<FoliagePaintTool>("FoliagePaintTool", typeid(FoliagePaintTool).name());
ReflectionSystem::AddType<siv::BasicPerlinNoise<float>>("siv::BasicPerlinNoise<float>", typeid(siv::BasicPerlinNoise<float>).name());
...
ReflectionSystem::AddType<FoliagePaintWindow>("FoliagePaintWindow", typeid(FoliagePaintWindow).name());
ReflectionSystem::AddType<ImGuiTextureUtils>("ImGuiTextureUtils", typeid(ImGuiTextureUtils).name());
ReflectionSystem::AddType<ConsoleWindow>("ConsoleWindow", typeid(ConsoleWindow).name());
...
ReflectionSystem::AddType<ConsoleCommand>("ConsoleCommand", typeid(ConsoleCommand).name());
ReflectionSystem::AddType<CVarSystem>("CVarSystem", typeid(CVarSystem).name());
ReflectionSystem::AddType<CheatCommands>("CheatCommands", typeid(CheatCommands).name());
...
ReflectionSystem::AddType<List<BLAS *>>("List<BLAS *>", typeid(List<BLAS *>).name());
...
ReflectionSystem::AddType<List<ConsoleCommand>>("List<ConsoleCommand>", typeid(List<ConsoleCommand>).name());
...
ReflectionSystem::AddType<List<FoliageType>>("List<FoliageType>", typeid(List<FoliageType>).name());
...
ReflectionSystem::AddType<List<IGPUBuffer *>>("List<IGPUBuffer *>", typeid(List<IGPUBuffer *>).name());
...
ReflectionSystem::AddType<List<VulkanImage *>>("List<VulkanImage *>", typeid(List<VulkanImage *>).name());
...
ReflectionSystem::AddType<Delegate<void (const List<std::basic_string<char>> &)>>("Delegate<void (const List<std::basic_string<char>> &)>", typeid(Delegate<void (const List<std::basic_string<char>> &)>).name());
...
ReflectionSystem::AddType<FoliageType>("FoliageType", typeid(FoliageType).name());
ReflectionSystem::AddType<FoliageSystem>("FoliageSystem", typeid(FoliageSystem).name());
...
ReflectionSystem::AddType<BLAS>("BLAS", typeid(BLAS).name());
...
ReflectionSystem::AddType<PrePass>("PrePass", typeid(PrePass).name());
ReflectionSystem::AddType<Mesh>("Mesh", typeid(Mesh).name());
ReflectionSystem::AddType<IGPUAccelerationStructure>("IGPUAccelerationStructure", typeid(IGPUAccelerationStructure).name());
...
ReflectionSystem::AddType<RenderGraph>("RenderGraph", typeid(RenderGraph).name());
ReflectionSystem::AddType<ResourceState>("ResourceState", typeid(ResourceState).name());
ReflectionSystem::AddType<ResourceUsage>("ResourceUsage", typeid(ResourceUsage).name());
ReflectionSystem::AddType<ComputePass>("ComputePass", typeid(ComputePass).name());
ReflectionSystem::AddType<FoliagePass>("FoliagePass", typeid(FoliagePass).name());
ReflectionSystem::AddType<FoliageCullPass>("FoliageCullPass", typeid(FoliageCullPass).name());
ReflectionSystem::AddType<FoliagePrePass>("FoliagePrePass", typeid(FoliagePrePass).name());
...
ReflectionSystem::AddType<FoliageInstanceData>("FoliageInstanceData", typeid(FoliageInstanceData).name());
ReflectionSystem::AddType<FoliageSceneHeader>("FoliageSceneHeader", typeid(FoliageSceneHeader).name());
ReflectionSystem::AddType<FoliageScalabilitySettings>("FoliageScalabilitySettings", typeid(FoliageScalabilitySettings).name());
ReflectionSystem::AddType<FoliageBladeData>("FoliageBladeData", typeid(FoliageBladeData).name());
ReflectionSystem::AddType<FoliageDrawCommand>("FoliageDrawCommand", typeid(FoliageDrawCommand).name());
...
{
Model* instance = static_cast<Model*>(inInstance);
const List<BLAS *> & result = instance->GetBLASes();
return (void*)&result;
});
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("GetBLASes", ReflectionSystem::GetOrCreateType<const List<BLAS *> &>("const List<BLAS *> &"), invoker, arguments));
}
}
{ 
	Type* currentClass = ReflectionSystem::GetMutableType<FoliagePaintTool>();
	{
		Field& currentField = currentClass->AddField(Field("myDirty", -1, ReflectionSystem::GetOrCreateType<bool>("bool"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myLastRegenFrame", -1, ReflectionSystem::GetOrCreateType<int>("int"), false, false));
	}
	currentClass->AddBaseType(ReflectionSystem::GetMutableType<EditorSystem>());
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
FoliagePaintTool* instance = static_cast<FoliagePaintTool*>(inInstance);
instance->Tick();
return nullptr;
});
List<MethodArgument> arguments{};
...
{ 
	Type* currentClass = ReflectionSystem::GetMutableType<siv::BasicPerlinNoise<float>>();
...
{ 
	...
	{
		Field& currentField = currentClass->AddField(Field("myIndirectDrawBuffers", -1, ReflectionSystem::GetOrCreateType<List<IGPUBuffer *>>("List<IGPUBuffer *>"), false, false));
	}
	{
...
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("GetName", ReflectionSystem::GetOrCreateType<const char *>("const char *"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
IRenderPass* instance = static_cast<IRenderPass*>(inInstance);
const VulkanDescriptorSet & result = instance->GetDescriptorSet();
return (void*)&result;
});
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("GetDescriptorSet", ReflectionSystem::GetOrCreateType<const VulkanDescriptorSet &>("const VulkanDescriptorSet &"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
IRenderPass* instance = static_cast<IRenderPass*>(inInstance);
const List<ResourceUsage> & result = instance->GetDynamicResourceUsages();
return (void*)&result;
});
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("GetDynamicResourceUsages", ReflectionSystem::GetOrCreateType<const List<ResourceUsage> &>("const List<ResourceUsage> &"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
IRenderPass* instance = static_cast<IRenderPass*>(inInstance);
static thread_local List<ResourceUsage> result = instance->GetIndirectDrawUsages();
return (void*)&result;
});
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("GetIndirectDrawUsages", ReflectionSystem::GetOrCreateType<List<ResourceUsage>>("List<ResourceUsage>"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
...
vk::Flags<vk::AccessFlagBits>& arg4 = *(vk::Flags<vk::AccessFlagBits>*)inArguments[4];
instance->BindBuffer(arg0, arg1, arg2, arg3, arg4);
return nullptr;
});
List<MethodArgument> arguments{};
...
vk::Flags<vk::AccessFlagBits>& arg5 = *(vk::Flags<vk::AccessFlagBits>*)inArguments[5];
instance->BindImage(arg0, arg1, arg2, arg3, arg4, arg5);
return nullptr;
});
List<MethodArgument> arguments{};
...
CameraComponent* instance = static_cast<CameraComponent*>(inInstance);
const glm::vec<2, float> & arg0 = *(const glm::vec<2, float>*)inArguments[0];
instance->SetResolution(arg0);
return nullptr;
});
List<MethodArgument> arguments{};
arguments.Add(MethodArgument("inResolution", ReflectionSystem::GetOrCreateType<const glm::vec<2, float> &>("const glm::vec<2, float> &")));
Method& currentMethod = currentClass->AddMethod(Method("SetResolution", ReflectionSystem::GetOrCreateType<void>("void"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
CameraComponent* instance = static_cast<CameraComponent*>(inInstance);
const glm::vec<2, float> & result = instance->GetResolution();
return (void*)&result;
});
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("GetResolution", ReflectionSystem::GetOrCreateType<const glm::vec<2, float> &>("const glm::vec<2, float> &"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
...
{ 
	...
	{
		Field& currentField = currentClass->AddField(Field("myDisplayMode", -1, ReflectionSystem::GetOrCreateType<Viewport::DisplayMode>("Viewport::DisplayMode"), false, false));
	}
	{
...
{
Viewport* instance = static_cast<Viewport*>(inInstance);
static thread_local bool result = instance->IsMouseOverViewport();
return (void*)&result;
});
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("IsMouseOverViewport", ReflectionSystem::GetOrCreateType<bool>("bool"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
...
{ 
	Type* currentClass = ReflectionSystem::GetMutableType<FoliagePaintWindow>();
	{
		Field& currentField = currentClass->AddField(Field("myPaintEnabled", -1, ReflectionSystem::GetOrCreateType<bool>("bool"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myActiveType", -1, ReflectionSystem::GetOrCreateType<int>("int"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myBrushRadius", -1, ReflectionSystem::GetOrCreateType<float>("float"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myStrength", -1, ReflectionSystem::GetOrCreateType<float>("float"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myErase", -1, ReflectionSystem::GetOrCreateType<bool>("bool"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myMaxDistanceScale", -1, ReflectionSystem::GetOrCreateType<float>("float"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myDensityScale", -1, ReflectionSystem::GetOrCreateType<float>("float"), false, false));
	}
	currentClass->AddBaseType(ReflectionSystem::GetMutableType<EditorWindow>());
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
FoliagePaintWindow* instance = static_cast<FoliagePaintWindow*>(inInstance);
static thread_local bool result = instance->IsPaintEnabled();
return (void*)&result;
});
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("IsPaintEnabled", ReflectionSystem::GetOrCreateType<bool>("bool"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
FoliagePaintWindow* instance = static_cast<FoliagePaintWindow*>(inInstance);
static thread_local int result = instance->GetActiveType();
return (void*)&result;
});
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("GetActiveType", ReflectionSystem::GetOrCreateType<int>("int"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
FoliagePaintWindow* instance = static_cast<FoliagePaintWindow*>(inInstance);
static thread_local float result = instance->GetBrushRadius();
return (void*)&result;
});
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("GetBrushRadius", ReflectionSystem::GetOrCreateType<float>("float"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
FoliagePaintWindow* instance = static_cast<FoliagePaintWindow*>(inInstance);
static thread_local float result = instance->GetStrength();
return (void*)&result;
});
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("GetStrength", ReflectionSystem::GetOrCreateType<float>("float"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
FoliagePaintWindow* instance = static_cast<FoliagePaintWindow*>(inInstance);
static thread_local bool result = instance->IsErase();
return (void*)&result;
});
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("IsErase", ReflectionSystem::GetOrCreateType<bool>("bool"), invoker, arguments));
}
}
{ 
...
{ 
	Type* currentClass = ReflectionSystem::GetMutableType<ConsoleWindow>();
	{
		Field& currentField = currentClass->AddField(Field("myInputBuffer", -1, ReflectionSystem::GetOrCreateType<std::basic_string<char>>("std::basic_string<char>"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myScrollToBottom", -1, ReflectionSystem::GetOrCreateType<bool>("bool"), false, false));
	}
	currentClass->AddBaseType(ReflectionSystem::GetMutableType<EditorWindow>());
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
ConsoleWindow* instance = static_cast<ConsoleWindow*>(inInstance);
instance->Tick();
return nullptr;
});
List<MethodArgument> arguments{};
...
AssetRegistry* instance = static_cast<AssetRegistry*>(inInstance);
const std::filesystem::path & arg0 = *(const std::filesystem::path*)inArguments[0];
static thread_local std::filesystem::path result = instance->TryRedirectPath(arg0);
return (void*)&result;
});
List<MethodArgument> arguments{};
arguments.Add(MethodArgument("inSourcePath", ReflectionSystem::GetOrCreateType<const std::filesystem::path &>("const std::filesystem::path &")));
Method& currentMethod = currentClass->AddMethod(Method("TryRedirectPath", ReflectionSystem::GetOrCreateType<std::filesystem::path>("std::filesystem::path"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
...
{ 
	...
	{
		Field& currentField = currentClass->AddField(Field("myImages", -1, ReflectionSystem::GetOrCreateType<List<VulkanImage *>>("List<VulkanImage *>"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myCommandPool", -1, ReflectionSystem::GetOrCreateType<vk::CommandPool>("vk::CommandPool"), false, false));
	}
...
VulkanSwapChain* instance = static_cast<VulkanSwapChain*>(inInstance);
const unsigned int& arg0 = *(const unsigned int*)inArguments[0];
static thread_local vk::ImageView result = instance->GetImageView(arg0);
return (void*)&result;
});
List<MethodArgument> arguments{};
...
VulkanSwapChain* instance = static_cast<VulkanSwapChain*>(inInstance);
const unsigned int& arg0 = *(const unsigned int*)inArguments[0];
VulkanImage * result = instance->GetImage(arg0);
return (void*)result;
});
List<MethodArgument> arguments{};
arguments.Add(MethodArgument("inIndex", ReflectionSystem::GetOrCreateType<const unsigned int>("const unsigned int")));
...
{
Method* instance = static_cast<Method*>(inInstance);
const List<MethodArgument> & result = instance->GetArguments();
return (void*)&result;
});
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("GetArguments", ReflectionSystem::GetOrCreateType<const List<MethodArgument> &>("const List<MethodArgument> &"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
...
void * result = instance->InvokeRaw(arg0, arg1);
return (void*)result;
});
List<MethodArgument> arguments{};
arguments.Add(MethodArgument("inInstance", ReflectionSystem::GetOrCreateType<void *>("void *")));
arguments.Add(MethodArgument("inArguments", ReflectionSystem::GetOrCreateType<const List<void *> &>("const List<void *> &")));
Method& currentMethod = currentClass->AddMethod(Method("InvokeRaw", ReflectionSystem::GetOrCreateType<void *>("void *"), invoker, arguments));
}
}
{ 
...
{ 
	Type* currentClass = ReflectionSystem::GetMutableType<ConsoleCommand>();
	{
	...
	{
		Field& currentField = currentClass->AddField(Field("myHelp", -1, ReflectionSystem::GetOrCreateType<std::basic_string<char>>("std::basic_string<char>"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myOwningType", -1, ReflectionSystem::GetOrCreateType<const Type>("const Type"), true, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myMethod", -1, ReflectionSystem::GetOrCreateType<const Method>("const Method"), true, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myNativeCallback", -1, ReflectionSystem::GetOrCreateType<Delegate<void (const List<std::basic_string<char>> &)>>("Delegate<void (const List<std::basic_string<char>> &)>"), false, false));
	}
}
{ 
	Type* currentClass = ReflectionSystem::GetMutableType<CVarSystem>();
	{
		Field& currentField = currentClass->AddField(Field("myCommands", -1, ReflectionSystem::GetOrCreateType<List<ConsoleCommand>>("List<ConsoleCommand>"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myOutputLog", -1, ReflectionSystem::GetOrCreateType<List<std::basic_string<char>>>("List<std::basic_string<char>>"), false, false));
	}
	currentClass->AddBaseType(ReflectionSystem::GetMutableType<System>());
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
CVarSystem* instance = static_cast<CVarSystem*>(inInstance);
instance->Init();
return nullptr;
});
List<MethodArgument> arguments{};
...
{
CVarSystem* instance = static_cast<CVarSystem*>(inInstance);
CVarSystem & result = instance->Get();
return (void*)&result;
});
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("Get", ReflectionSystem::GetOrCreateType<CVarSystem &>("CVarSystem &"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
...
List<MethodArgument> arguments{};
arguments.Add(MethodArgument("inCommandLine", ReflectionSystem::GetOrCreateType<const std::basic_string<char> &>("const std::basic_string<char> &")));
...
const std::basic_string<char> & arg0 = *(const std::basic_string<char>*)inArguments[0];
const std::basic_string<char> & arg1 = *(const std::basic_string<char>*)inArguments[1];
const Delegate<void (const List<std::basic_string<char>> &)> & arg2 = *(const Delegate<void (const List<std::basic_string<char>> &)>*)inArguments[2];
instance->RegisterCommand(arg0, arg1, arg2);
return nullptr;
});
List<MethodArgument> arguments{};
arguments.Add(MethodArgument("inName", ReflectionSystem::GetOrCreateType<const std::basic_string<char> &>("const std::basic_string<char> &")));
arguments.Add(MethodArgument("inHelp", ReflectionSystem::GetOrCreateType<const std::basic_string<char> &>("const std::basic_string<char> &")));
arguments.Add(MethodArgument("inCallback", ReflectionSystem::GetOrCreateType<const Delegate<void (const List<std::basic_string<char>> &)> &>("const Delegate<void (const List<std::basic_string<char>> &)> &")));
Method& currentMethod = currentClass->AddMethod(Method("RegisterCommand", ReflectionSystem::GetOrCreateType<void>("void"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
CVarSystem* instance = static_cast<CVarSystem*>(inInstance);
const std::basic_string<char> & arg0 = *(const std::basic_string<char>*)inArguments[0];
const ConsoleCommand * result = instance->FindCommand(arg0);
return (void*)result;
});
List<MethodArgument> arguments{};
arguments.Add(MethodArgument("inName", ReflectionSystem::GetOrCreateType<const std::basic_string<char> &>("const std::basic_string<char> &")));
Method& currentMethod = currentClass->AddMethod(Method("FindCommand", ReflectionSystem::GetOrCreateType<const ConsoleCommand *>("const ConsoleCommand *"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
CVarSystem* instance = static_cast<CVarSystem*>(inInstance);
const List<ConsoleCommand> & result = instance->GetCommands();
return (void*)&result;
});
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("GetCommands", ReflectionSystem::GetOrCreateType<const List<ConsoleCommand> &>("const List<ConsoleCommand> &"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
CVarSystem* instance = static_cast<CVarSystem*>(inInstance);
const List<std::basic_string<char>> & result = instance->GetOutputLog();
return (void*)&result;
});
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("GetOutputLog", ReflectionSystem::GetOrCreateType<const List<std::basic_string<char>> &>("const List<std::basic_string<char>> &"), invoker, arguments));
}
}
{ 
	Type* currentClass = ReflectionSystem::GetMutableType<CheatCommands>();
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
CheatCommands* instance = static_cast<CheatCommands*>(inInstance);
bool& arg0 = *(bool*)inArguments[0];
instance->GodMode(arg0);
return nullptr;
});
List<MethodArgument> arguments{};
arguments.Add(MethodArgument("enabled", ReflectionSystem::GetOrCreateType<bool>("bool")));
Method& currentMethod = currentClass->AddMethod(Method("GodMode", ReflectionSystem::GetOrCreateType<void>("void"), invoker, arguments));
currentMethod.AddMetadata(R"delim(Cheat)delim");
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
...
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("NoClip", ReflectionSystem::GetOrCreateType<void>("void"), invoker, arguments));
currentMethod.AddMetadata(R"delim(Cheat)delim");
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
...
List<MethodArgument> arguments{};
arguments.Add(MethodArgument("scale", ReflectionSystem::GetOrCreateType<float>("float")));
...
CheatCommands* instance = static_cast<CheatCommands*>(inInstance);
std::basic_string<char>& arg0 = *(std::basic_string<char>*)inArguments[0];
int& arg1 = *(int*)inArguments[1];
instance->GiveItem(arg0, arg1);
return nullptr;
});
List<MethodArgument> arguments{};
arguments.Add(MethodArgument("item", ReflectionSystem::GetOrCreateType<std::basic_string<char>>("std::basic_string<char>")));
arguments.Add(MethodArgument("count", ReflectionSystem::GetOrCreateType<int>("int")));
Method& currentMethod = currentClass->AddMethod(Method("GiveItem", ReflectionSystem::GetOrCreateType<void>("void"), invoker, arguments));
currentMethod.AddMetadata(R"delim(Cheat)delim");
}
}
{ 
...
{ 
	Type* currentClass = ReflectionSystem::GetMutableType<List<BLAS *>>();
	currentClass->AddBaseType(ReflectionSystem::GetMutableType<IList>());
	currentClass->AddTemplateArgument(ReflectionSystem::GetOrCreateType<BLAS>("BLAS"), true, false);
}
{ 
...
{ 
	Type* currentClass = ReflectionSystem::GetMutableType<List<ConsoleCommand>>();
	currentClass->AddBaseType(ReflectionSystem::GetMutableType<IList>());
	currentClass->AddTemplateArgument(ReflectionSystem::GetOrCreateType<ConsoleCommand>("ConsoleCommand"), false, false);
}
{ 
...
{ 
	Type* currentClass = ReflectionSystem::GetMutableType<List<FoliageType>>();
	currentClass->AddBaseType(ReflectionSystem::GetMutableType<IList>());
	currentClass->AddTemplateArgument(ReflectionSystem::GetOrCreateType<FoliageType>("FoliageType"), false, false);
}
{ 
...
{ 
	Type* currentClass = ReflectionSystem::GetMutableType<List<ResourceUsage>>();
	currentClass->AddBaseType(ReflectionSystem::GetMutableType<IList>());
	currentClass->AddTemplateArgument(ReflectionSystem::GetOrCreateType<ResourceUsage>("ResourceUsage"), false, false);
}
{ 
	Type* currentClass = ReflectionSystem::GetMutableType<List<IGPUBuffer *>>();
	currentClass->AddBaseType(ReflectionSystem::GetMutableType<IList>());
	currentClass->AddTemplateArgument(ReflectionSystem::GetOrCreateType<IGPUBuffer>("IGPUBuffer"), true, false);
}
{ 
...
{ 
	Type* currentClass = ReflectionSystem::GetMutableType<List<VulkanImage *>>();
	currentClass->AddBaseType(ReflectionSystem::GetMutableType<IList>());
	currentClass->AddTemplateArgument(ReflectionSystem::GetOrCreateType<VulkanImage>("VulkanImage"), true, false);
}
{ 
...
IGPUAccelerationStructure * arg0 = (IGPUAccelerationStructure*)inArguments[0];
List<std::basic_string<char>>& arg1 = *(List<std::basic_string<char>>*)inArguments[1];
instance->RegisterAccelerationStructure(arg0, arg1);
return nullptr;
});
List<MethodArgument> arguments{};
arguments.Add(MethodArgument("inAS", ReflectionSystem::GetOrCreateType<IGPUAccelerationStructure *>("IGPUAccelerationStructure *")));
...
GPUResourceManager* instance = static_cast<GPUResourceManager*>(inInstance);
const std::basic_string<char> & arg0 = *(const std::basic_string<char>*)inArguments[0];
IGPUAccelerationStructure * result = instance->GetAccelerationStructure(arg0);
return (void*)result;
});
List<MethodArgument> arguments{};
...
Method& currentMethod = currentClass->AddMethod(Method("GetAccelerationStructure", ReflectionSystem::GetOrCreateType<IGPUAccelerationStructure *>("IGPUAccelerationStructure *"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
GPUResourceManager* instance = static_cast<GPUResourceManager*>(inInstance);
const std::basic_string<char> & arg0 = *(const std::basic_string<char>*)inArguments[0];
IGPUAccelerationStructure * result = instance->TryGetAccelerationStructure(arg0);
return (void*)result;
});
List<MethodArgument> arguments{};
arguments.Add(MethodArgument("inAlias", ReflectionSystem::GetOrCreateType<const std::basic_string<char> &>("const std::basic_string<char> &")));
Method& currentMethod = currentClass->AddMethod(Method("TryGetAccelerationStructure", ReflectionSystem::GetOrCreateType<IGPUAccelerationStructure *>("IGPUAccelerationStructure *"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
...
{ 
	Type* currentClass = ReflectionSystem::GetMutableType<Delegate<void (const List<std::basic_string<char>> &)>>();
	currentClass->AddTemplateArgument(ReflectionSystem::GetOrCreateType<void (const List<std::basic_string<char>> &)>("void (const List<std::basic_string<char>> &)"), false, false);
}
{ 
...
{
Color* instance = static_cast<Color*>(inInstance);
static thread_local int result = instance->ToPackedInt();
return (void*)&result;
});
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("ToPackedInt", ReflectionSystem::GetOrCreateType<int>("int"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
...
{ 
	...
	{
		Field& currentField = currentClass->AddField(Field("R", -1, ReflectionSystem::GetOrCreateType<float>("float"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("G", -1, ReflectionSystem::GetOrCreateType<float>("float"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("B", -1, ReflectionSystem::GetOrCreateType<float>("float"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("A", -1, ReflectionSystem::GetOrCreateType<float>("float"), false, false));
	}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
...
{ 
	Type* currentClass = ReflectionSystem::GetMutableType<FoliageType>();
	{
		Field& currentField = currentClass->AddField(Field("myName", -1, ReflectionSystem::GetOrCreateType<std::basic_string<char>>("std::basic_string<char>"), false, false));
	}
	{
	...
	{
		Field& currentField = currentClass->AddField(Field("myTint", -1, ReflectionSystem::GetOrCreateType<glm::vec<3, float>>("glm::vec<3, float>"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myMinScale", -1, ReflectionSystem::GetOrCreateType<float>("float"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myMaxScale", -1, ReflectionSystem::GetOrCreateType<float>("float"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myDensityMultiplier", -1, ReflectionSystem::GetOrCreateType<float>("float"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myDensityMap", -1, ReflectionSystem::GetOrCreateType<List<float>>("List<float>"), false, false));
	}
}
{ 
	Type* currentClass = ReflectionSystem::GetMutableType<FoliageSystem>();
	{
	...
	{
		Field& currentField = currentClass->AddField(Field("myTypes", -1, ReflectionSystem::GetOrCreateType<List<FoliageType>>("List<FoliageType>"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myInstanceBuffer", -1, ReflectionSystem::GetOrCreateType<VulkanBuffer>("VulkanBuffer"), true, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myHeaderBuffer", -1, ReflectionSystem::GetOrCreateType<VulkanBuffer>("VulkanBuffer"), true, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myIndirectBuffer", -1, ReflectionSystem::GetOrCreateType<VulkanBuffer>("VulkanBuffer"), true, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myBladeBuffer", -1, ReflectionSystem::GetOrCreateType<VulkanBuffer>("VulkanBuffer"), true, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myScalabilityBuffer", -1, ReflectionSystem::GetOrCreateType<VulkanBuffer>("VulkanBuffer"), true, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("mySettings", -1, ReflectionSystem::GetOrCreateType<FoliageScalabilitySettings>("FoliageScalabilitySettings"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myNumInstances", -1, ReflectionSystem::GetOrCreateType<unsigned int>("unsigned int"), false, false));
	}
	currentClass->AddBaseType(ReflectionSystem::GetMutableType<System>());
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
FoliageSystem* instance = static_cast<FoliageSystem*>(inInstance);
instance->Init();
return nullptr;
});
List<MethodArgument> arguments{};
...
{
FoliageSystem* instance = static_cast<FoliageSystem*>(inInstance);
static thread_local unsigned int result = instance->GetNumInstances();
return (void*)&result;
});
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("GetNumInstances", ReflectionSystem::GetOrCreateType<unsigned int>("unsigned int"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
FoliageSystem* instance = static_cast<FoliageSystem*>(inInstance);
static thread_local unsigned int result = instance->GetCapacity();
return (void*)&result;
});
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("GetCapacity", ReflectionSystem::GetOrCreateType<unsigned int>("unsigned int"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
...
{
FoliageSystem* instance = static_cast<FoliageSystem*>(inInstance);
static thread_local int result = instance->GetTypeCount();
return (void*)&result;
});
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("GetTypeCount", ReflectionSystem::GetOrCreateType<int>("int"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
FoliageSystem* instance = static_cast<FoliageSystem*>(inInstance);
int& arg0 = *(int*)inArguments[0];
const std::basic_string<char> & result = instance->GetTypeName(arg0);
return (void*)&result;
});
List<MethodArgument> arguments{};
arguments.Add(MethodArgument("inTypeIndex", ReflectionSystem::GetOrCreateType<int>("int")));
Method& currentMethod = currentClass->AddMethod(Method("GetTypeName", ReflectionSystem::GetOrCreateType<const std::basic_string<char> &>("const std::basic_string<char> &"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
FoliageSystem* instance = static_cast<FoliageSystem*>(inInstance);
int& arg0 = *(int*)inArguments[0];
const glm::vec<3, float> & result = instance->GetTypeTint(arg0);
return (void*)&result;
});
List<MethodArgument> arguments{};
arguments.Add(MethodArgument("inTypeIndex", ReflectionSystem::GetOrCreateType<int>("int")));
Method& currentMethod = currentClass->AddMethod(Method("GetTypeTint", ReflectionSystem::GetOrCreateType<const glm::vec<3, float> &>("const glm::vec<3, float> &"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
FoliageSystem* instance = static_cast<FoliageSystem*>(inInstance);
int& arg0 = *(int*)inArguments[0];
const glm::vec<2, float> & arg1 = *(const glm::vec<2, float>*)inArguments[1];
float& arg2 = *(float*)inArguments[2];
float& arg3 = *(float*)inArguments[3];
bool& arg4 = *(bool*)inArguments[4];
instance->PaintDensity(arg0, arg1, arg2, arg3, arg4);
return nullptr;
});
List<MethodArgument> arguments{};
arguments.Add(MethodArgument("inTypeIndex", ReflectionSystem::GetOrCreateType<int>("int")));
arguments.Add(MethodArgument("inWorldXZ", ReflectionSystem::GetOrCreateType<const glm::vec<2, float> &>("const glm::vec<2, float> &")));
arguments.Add(MethodArgument("inWorldRadius", ReflectionSystem::GetOrCreateType<float>("float")));
arguments.Add(MethodArgument("inStrength", ReflectionSystem::GetOrCreateType<float>("float")));
arguments.Add(MethodArgument("inAdditive", ReflectionSystem::GetOrCreateType<bool>("bool")));
Method& currentMethod = currentClass->AddMethod(Method("PaintDensity", ReflectionSystem::GetOrCreateType<void>("void"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
...
glm::vec<3, float> & arg2 = *(glm::vec<3, float>*)inArguments[2];
static thread_local bool result = instance->RaycastHeightfield(arg0, arg1, arg2);
return (void*)&result;
});
List<MethodArgument> arguments{};
...
arguments.Add(MethodArgument("outHitPos", ReflectionSystem::GetOrCreateType<glm::vec<3, float> &>("glm::vec<3, float> &")));
Method& currentMethod = currentClass->AddMethod(Method("RaycastHeightfield", ReflectionSystem::GetOrCreateType<bool>("bool"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
FoliageSystem* instance = static_cast<FoliageSystem*>(inInstance);
int& arg0 = *(int*)inArguments[0];
float& arg1 = *(float*)inArguments[1];
instance->SetTypeDensity(arg0, arg1);
return nullptr;
});
List<MethodArgument> arguments{};
arguments.Add(MethodArgument("inTypeIndex", ReflectionSystem::GetOrCreateType<int>("int")));
arguments.Add(MethodArgument("inValue", ReflectionSystem::GetOrCreateType<float>("float")));
Method& currentMethod = currentClass->AddMethod(Method("SetTypeDensity", ReflectionSystem::GetOrCreateType<void>("void"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
FoliageSystem* instance = static_cast<FoliageSystem*>(inInstance);
instance->RegenerateInstances();
return nullptr;
});
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("RegenerateInstances", ReflectionSystem::GetOrCreateType<void>("void"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
...
float& arg0 = *(float*)inArguments[0];
float& arg1 = *(float*)inArguments[1];
instance->SetScalability(arg0, arg1);
return nullptr;
});
List<MethodArgument> arguments{};
arguments.Add(MethodArgument("inMaxDistanceScale", ReflectionSystem::GetOrCreateType<float>("float")));
arguments.Add(MethodArgument("inDensityScale", ReflectionSystem::GetOrCreateType<float>("float")));
Method& currentMethod = currentClass->AddMethod(Method("SetScalability", ReflectionSystem::GetOrCreateType<void>("void"), invoker, arguments));
}
}
{ 
...
{ 
	Type* currentClass = ReflectionSystem::GetMutableType<BLAS>();
	{
	...
	{
		Field& currentField = currentClass->AddField(Field("myBLASBuffer", -1, ReflectionSystem::GetOrCreateType<VulkanBuffer>("VulkanBuffer"), true, false));
	}
	{
...
static thread_local vk::AccelerationStructureKHR result = instance->GetAccelerationStructure();
return (void*)&result;
});
List<MethodArgument> arguments{};
...
{
BLAS* instance = static_cast<BLAS*>(inInstance);
static thread_local unsigned long long result = instance->GetDeviceAddress();
return (void*)&result;
});
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("GetDeviceAddress", ReflectionSystem::GetOrCreateType<unsigned long long>("unsigned long long"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
BLAS* instance = static_cast<BLAS*>(inInstance);
const List<glm::vec<3, float>> & arg0 = *(const List<glm::vec<3, float>>*)inArguments[0];
const List<unsigned int> & arg1 = *(const List<unsigned int>*)inArguments[1];
BLAS * result = instance->Build(arg0, arg1);
return (void*)result;
});
List<MethodArgument> arguments{};
arguments.Add(MethodArgument("inPositions", ReflectionSystem::GetOrCreateType<const List<glm::vec<3, float>> &>("const List<glm::vec<3, float>> &")));
arguments.Add(MethodArgument("inIndices", ReflectionSystem::GetOrCreateType<const List<unsigned int> &>("const List<unsigned int> &")));
Method& currentMethod = currentClass->AddMethod(Method("Build", ReflectionSystem::GetOrCreateType<BLAS *>("BLAS *"), invoker, arguments));
}
}
{ 
...
{ 
	Type* currentClass = ReflectionSystem::GetMutableType<PrePass>();
	currentClass->AddBaseType(ReflectionSystem::GetMutableType<GraphicsPass>());
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
PrePass* instance = static_cast<PrePass*>(inInstance);
instance->SetupAttachments();
return nullptr;
});
List<MethodArgument> arguments{};
...
{ 
	Type* currentClass = ReflectionSystem::GetMutableType<IGPUAccelerationStructure>();
}
{ 
...
{ 
	Type* currentClass = ReflectionSystem::GetMutableType<RenderGraph>();
	{
		Field& currentField = currentClass->AddField(Field("myPasses", -1, ReflectionSystem::GetOrCreateType<List<IRenderPass *>>("List<IRenderPass *>"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myGlobalResourceState", -1, ReflectionSystem::GetOrCreateType<std::map<const void *, ResourceState>>("std::map<const void *, ResourceState>"), false, false));
	}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
...
List<MethodArgument> arguments{};
arguments.Add(MethodArgument("inRenderPass", ReflectionSystem::GetOrCreateType<IRenderPass *>("IRenderPass *")));
Method& currentMethod = currentClass->AddMethod(Method("AddPass", ReflectionSystem::GetOrCreateType<void>("void"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
...
{ 
	...
	{
		Field& currentField = currentClass->AddField(Field("myStage", -1, ReflectionSystem::GetOrCreateType<vk::Flags<vk::PipelineStageFlagBits>>("vk::Flags<vk::PipelineStageFlagBits>"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myAccessFlags", -1, ReflectionSystem::GetOrCreateType<vk::Flags<vk::AccessFlagBits>>("vk::Flags<vk::AccessFlagBits>"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myLayout", -1, ReflectionSystem::GetOrCreateType<vk::ImageLayout>("vk::ImageLayout"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myQueueFamilyIndex", -1, ReflectionSystem::GetOrCreateType<unsigned int>("unsigned int"), false, false));
	}
}
{ 
	Type* currentClass = ReflectionSystem::GetMutableType<ResourceUsage>();
	{
		Field& currentField = currentClass->AddField(Field("myImage", -1, ReflectionSystem::GetOrCreateType<const VulkanImage>("const VulkanImage"), true, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myBuffer", -1, ReflectionSystem::GetOrCreateType<const VulkanBuffer>("const VulkanBuffer"), true, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myAccelerationStructure", -1, ReflectionSystem::GetOrCreateType<vk::AccelerationStructureKHR>("vk::AccelerationStructureKHR"), false, false));
	}
...
{
ResourceUsage* instance = static_cast<ResourceUsage*>(inInstance);
const vk::AccelerationStructureKHR& arg0 = *(const vk::AccelerationStructureKHR*)inArguments[0];
vk::Flags<vk::PipelineStageFlagBits>& arg1 = *(vk::Flags<vk::PipelineStageFlagBits>*)inArguments[1];
vk::Flags<vk::AccessFlagBits>& arg2 = *(vk::Flags<vk::AccessFlagBits>*)inArguments[2];
...
List<MethodArgument> arguments{};
arguments.Add(MethodArgument("inAS", ReflectionSystem::GetOrCreateType<const vk::AccelerationStructureKHR>("const vk::AccelerationStructureKHR")));
arguments.Add(MethodArgument("inStages", ReflectionSystem::GetOrCreateType<vk::Flags<vk::PipelineStageFlagBits>>("vk::Flags<vk::PipelineStageFlagBits>")));
arguments.Add(MethodArgument("inAccessFlags", ReflectionSystem::GetOrCreateType<vk::Flags<vk::AccessFlagBits>>("vk::Flags<vk::AccessFlagBits>")));
...
{ 
	Type* currentClass = ReflectionSystem::GetMutableType<FoliagePass>();
	currentClass->AddBaseType(ReflectionSystem::GetMutableType<GraphicsPass>());
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
FoliagePass* instance = static_cast<FoliagePass*>(inInstance);
instance->SetupAttachments();
return nullptr;
});
List<MethodArgument> arguments{};
...
{
FoliagePass* instance = static_cast<FoliagePass*>(inInstance);
static thread_local vk::Flags<vk::CullModeFlagBits> result = instance->GetCullMode();
return (void*)&result;
});
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("GetCullMode", ReflectionSystem::GetOrCreateType<vk::Flags<vk::CullModeFlagBits>>("vk::Flags<vk::CullModeFlagBits>"), invoker, arguments));
}
}
{ 
	Type* currentClass = ReflectionSystem::GetMutableType<FoliageCullPass>();
	currentClass->AddBaseType(ReflectionSystem::GetMutableType<ComputePass>());
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
FoliageCullPass* instance = static_cast<FoliageCullPass*>(inInstance);
vk::CommandBuffer& arg0 = *(vk::CommandBuffer*)inArguments[0];
...
{ 
	Type* currentClass = ReflectionSystem::GetMutableType<FoliagePrePass>();
	currentClass->AddBaseType(ReflectionSystem::GetMutableType<IRenderPass>());
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
FoliagePrePass* instance = static_cast<FoliagePrePass*>(inInstance);
instance->PreExecute();
return nullptr;
});
List<MethodArgument> arguments{};
...
{
World* instance = static_cast<World*>(inInstance);
instance->RebuildTLAS();
return nullptr;
});
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("RebuildTLAS", ReflectionSystem::GetOrCreateType<void>("void"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
...
{ 
	...
	{
		Field& currentField = currentClass->AddField(Field("myDynamicColorAttachments", -1, ReflectionSystem::GetOrCreateType<List<vk::RenderingAttachmentInfo>>("List<vk::RenderingAttachmentInfo>"), false, false));
	}
	{
	...
	{
		Field& currentField = currentClass->AddField(Field("myAttachmentResourceUsages", -1, ReflectionSystem::GetOrCreateType<List<ResourceUsage>>("List<ResourceUsage>"), false, false));
	}
	{
	...
	{
		Field& currentField = currentClass->AddField(Field("myDynamicDepthAttachment", -1, ReflectionSystem::GetOrCreateType<vk::RenderingAttachmentInfo>("vk::RenderingAttachmentInfo"), false, false));
	}
	{
...
instance->GetDynamicColorAttachments();
return nullptr;
});
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("GetDynamicColorAttachments", ReflectionSystem::GetOrCreateType<void>("void"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
GraphicsPass* instance = static_cast<GraphicsPass*>(inInstance);
instance->GetDynamicDepthAttachments();
return nullptr;
});
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("GetDynamicDepthAttachments", ReflectionSystem::GetOrCreateType<void>("void"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
...
vk::AttachmentLoadOp& arg2 = *(vk::AttachmentLoadOp*)inArguments[2];
vk::AttachmentStoreOp& arg3 = *(vk::AttachmentStoreOp*)inArguments[3];
instance->AddDynamicColorAttachment(arg0, arg1, arg2, arg3);
return nullptr;
});
List<MethodArgument> arguments{};
arguments.Add(MethodArgument("inImage", ReflectionSystem::GetOrCreateType<VulkanImage *>("VulkanImage *")));
...
vk::AttachmentStoreOp& arg3 = *(vk::AttachmentStoreOp*)inArguments[3];
VulkanImage * arg4 = (VulkanImage*)inArguments[4];
instance->RegisterDynamicColorAttachment(arg0, arg1, arg2, arg3, arg4);
return nullptr;
});
List<MethodArgument> arguments{};
...
arguments.Add(MethodArgument("inStoreOp", ReflectionSystem::GetOrCreateType<vk::AttachmentStoreOp>("vk::AttachmentStoreOp")));
arguments.Add(MethodArgument("myResolveImage", ReflectionSystem::GetOrCreateType<VulkanImage *>("VulkanImage *")));
Method& currentMethod = currentClass->AddMethod(Method("RegisterDynamicColorAttachment", ReflectionSystem::GetOrCreateType<void>("void"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
...
instance->DrawFromShadingBin(arg0, arg1);
return nullptr;
});
List<MethodArgument> arguments{};
arguments.Add(MethodArgument("inCommandBuffer", ReflectionSystem::GetOrCreateType<vk::CommandBuffer>("vk::CommandBuffer")));
arguments.Add(MethodArgument("inShadingBin", ReflectionSystem::GetOrCreateType<const EShadingBin>("const EShadingBin")));
Method& currentMethod = currentClass->AddMethod(Method("DrawFromShadingBin", ReflectionSystem::GetOrCreateType<void>("void"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
GraphicsPass* instance = static_cast<GraphicsPass*>(inInstance);
instance->RegisterShadingBinIndirectBuffers();
return nullptr;
});
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("RegisterShadingBinIndirectBuffers", ReflectionSystem::GetOrCreateType<void>("void"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
...
vk::Flags<vk::AccessFlagBits>& arg2 = *(vk::Flags<vk::AccessFlagBits>*)inArguments[2];
vk::ImageLayout& arg3 = *(vk::ImageLayout*)inArguments[3];
instance->RegisterAttachmentUsage(arg0, arg1, arg2, arg3);
return nullptr;
});
List<MethodArgument> arguments{};
arguments.Add(MethodArgument("inImage", ReflectionSystem::GetOrCreateType<VulkanImage *>("VulkanImage *")));
arguments.Add(MethodArgument("inPipelineStageFlags", ReflectionSystem::GetOrCreateType<vk::Flags<vk::PipelineStageFlagBits>>("vk::Flags<vk::PipelineStageFlagBits>")));
arguments.Add(MethodArgument("inAccessFlags", ReflectionSystem::GetOrCreateType<vk::Flags<vk::AccessFlagBits>>("vk::Flags<vk::AccessFlagBits>")));
arguments.Add(MethodArgument("inLayout", ReflectionSystem::GetOrCreateType<vk::ImageLayout>("vk::ImageLayout")));
Method& currentMethod = currentClass->AddMethod(Method("RegisterAttachmentUsage", ReflectionSystem::GetOrCreateType<void>("void"), invoker, arguments));
}
}
{ 
...
{ 
	Type* currentClass = ReflectionSystem::GetMutableType<TLAS>();
	{
		Field& currentField = currentClass->AddField(Field("myAS", -1, ReflectionSystem::GetOrCreateType<vk::AccelerationStructureKHR>("vk::AccelerationStructureKHR"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myASBuffer", -1, ReflectionSystem::GetOrCreateType<VulkanBuffer>("VulkanBuffer"), true, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myInstanceBuffer", -1, ReflectionSystem::GetOrCreateType<VulkanBuffer>("VulkanBuffer"), true, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myScratchBuffer", -1, ReflectionSystem::GetOrCreateType<VulkanBuffer>("VulkanBuffer"), true, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myInstanceCapacity", -1, ReflectionSystem::GetOrCreateType<unsigned int>("unsigned int"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myScratchAlignment", -1, ReflectionSystem::GetOrCreateType<unsigned int>("unsigned int"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myDeviceAddress", -1, ReflectionSystem::GetOrCreateType<unsigned long long>("unsigned long long"), false, false));
	}
...
{
TLAS* instance = static_cast<TLAS*>(inInstance);
static thread_local bool result = instance->IsBuilt();
return (void*)&result;
});
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("IsBuilt", ReflectionSystem::GetOrCreateType<bool>("bool"), invoker, arguments));
}
}
{ 
...
{ 
	Type* currentClass = ReflectionSystem::GetMutableType<FoliageInstanceData>();
	{
		Field& currentField = currentClass->AddField(Field("myPosition", -1, ReflectionSystem::GetOrCreateType<glm::vec<3, float>>("glm::vec<3, float>"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myScale", -1, ReflectionSystem::GetOrCreateType<float>("float"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myRotationY", -1, ReflectionSystem::GetOrCreateType<float>("float"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myMeshIndex", -1, ReflectionSystem::GetOrCreateType<unsigned int>("unsigned int"), false, false));
	}
	...
	{
		Field& currentField = currentClass->AddField(Field("myTintPacked", -1, ReflectionSystem::GetOrCreateType<unsigned int>("unsigned int"), false, false));
	}
}
{ 
	Type* currentClass = ReflectionSystem::GetMutableType<FoliageSceneHeader>();
	{
		Field& currentField = currentClass->AddField(Field("myNumInstances", -1, ReflectionSystem::GetOrCreateType<unsigned int>("unsigned int"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myBinCapacity", -1, ReflectionSystem::GetOrCreateType<unsigned int>("unsigned int"), false, false));
	}
}
{ 
	Type* currentClass = ReflectionSystem::GetMutableType<FoliageScalabilitySettings>();
	{
		Field& currentField = currentClass->AddField(Field("myGlobalMaxDistanceScale", -1, ReflectionSystem::GetOrCreateType<float>("float"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myGlobalDensityScale", -1, ReflectionSystem::GetOrCreateType<float>("float"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myMaxDrawDistance", -1, ReflectionSystem::GetOrCreateType<float>("float"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myFadeStartDistance", -1, ReflectionSystem::GetOrCreateType<float>("float"), false, false));
	}
}
{ 
	Type* currentClass = ReflectionSystem::GetMutableType<FoliageBladeData>();
	{
		Field& currentField = currentClass->AddField(Field("myRootPosition", -1, ReflectionSystem::GetOrCreateType<glm::vec<3, float>>("glm::vec<3, float>"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myHeight", -1, ReflectionSystem::GetOrCreateType<float>("float"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myWidth", -1, ReflectionSystem::GetOrCreateType<float>("float"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myBend", -1, ReflectionSystem::GetOrCreateType<float>("float"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myYaw", -1, ReflectionSystem::GetOrCreateType<float>("float"), false, false));
	}
...
{ 
	Type* currentClass = ReflectionSystem::GetMutableType<FoliageDrawCommand>();
	{
		Field& currentField = currentClass->AddField(Field("vertexCount", -1, ReflectionSystem::GetOrCreateType<unsigned int>("unsigned int"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("instanceCount", -1, ReflectionSystem::GetOrCreateType<unsigned int>("unsigned int"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("firstVertex", -1, ReflectionSystem::GetOrCreateType<unsigned int>("unsigned int"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("firstInstance", -1, ReflectionSystem::GetOrCreateType<unsigned int>("unsigned int"), false, false));
	}
}
{ 
...
vk::Flags<vk::ShaderStageFlagBits>& arg0 = *(vk::Flags<vk::ShaderStageFlagBits>*)inArguments[0];
static thread_local vk::Flags<vk::PipelineStageFlagBits> result = instance->PipelineFlagsFromShaderStages(arg0);
return (void*)&result;
});
List<MethodArgument> arguments{};
arguments.Add(MethodArgument("inShaderStages", ReflectionSystem::GetOrCreateType<vk::Flags<vk::ShaderStageFlagBits>>("vk::Flags<vk::ShaderStageFlagBits>")));
Method& currentMethod = currentClass->AddMethod(Method("PipelineFlagsFromShaderStages", ReflectionSystem::GetOrCreateType<vk::Flags<vk::PipelineStageFlagBits>>("vk::Flags<vk::PipelineStageFlagBits>"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
...
{
ResizableBuffer* instance = static_cast<ResizableBuffer*>(inInstance);
MulticastDelegate<void ()> * result = instance->GetOnBufferResized();
return (void*)result;
});
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("GetOnBufferResized", ReflectionSystem::GetOrCreateType<MulticastDelegate<void ()> *>("MulticastDelegate<void ()> *"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
...
VulkanBuffer* instance = static_cast<VulkanBuffer*>(inInstance);
unsigned int& arg0 = *(unsigned int*)inArguments[0];
static thread_local vk::BufferCreateInfo result = instance->BLASInputCreateInfo(arg0);
return (void*)&result;
});
List<MethodArgument> arguments{};
arguments.Add(MethodArgument("inSize", ReflectionSystem::GetOrCreateType<unsigned int>("unsigned int")));
Method& currentMethod = currentClass->AddMethod(Method("BLASInputCreateInfo", ReflectionSystem::GetOrCreateType<vk::BufferCreateInfo>("vk::BufferCreateInfo"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
VulkanBuffer* instance = static_cast<VulkanBuffer*>(inInstance);
unsigned int& arg0 = *(unsigned int*)inArguments[0];
static thread_local vk::BufferCreateInfo result = instance->BLASStorageCreateInfo(arg0);
return (void*)&result;
});
List<MethodArgument> arguments{};
arguments.Add(MethodArgument("inSize", ReflectionSystem::GetOrCreateType<unsigned int>("unsigned int")));
Method& currentMethod = currentClass->AddMethod(Method("BLASStorageCreateInfo", ReflectionSystem::GetOrCreateType<vk::BufferCreateInfo>("vk::BufferCreateInfo"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
VulkanBuffer* instance = static_cast<VulkanBuffer*>(inInstance);
unsigned int& arg0 = *(unsigned int*)inArguments[0];
static thread_local vk::BufferCreateInfo result = instance->BLASScratchCreateInfo(arg0);
return (void*)&result;
});
List<MethodArgument> arguments{};
arguments.Add(MethodArgument("inSize", ReflectionSystem::GetOrCreateType<unsigned int>("unsigned int")));
Method& currentMethod = currentClass->AddMethod(Method("BLASScratchCreateInfo", ReflectionSystem::GetOrCreateType<vk::BufferCreateInfo>("vk::BufferCreateInfo"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
...
{
VulkanDescriptorSet* instance = static_cast<VulkanDescriptorSet*>(inInstance);
const IGPUBuffer * arg0 = (const IGPUBuffer*)inArguments[0];
vk::Flags<vk::ShaderStageFlagBits>& arg1 = *(vk::Flags<vk::ShaderStageFlagBits>*)inArguments[1];
unsigned int& arg2 = *(unsigned int*)inArguments[2];
vk::DescriptorType& arg3 = *(vk::DescriptorType*)inArguments[3];
vk::Flags<vk::AccessFlagBits>& arg4 = *(vk::Flags<vk::AccessFlagBits>*)inArguments[4];
...
List<MethodArgument> arguments{};
arguments.Add(MethodArgument("inBuffer", ReflectionSystem::GetOrCreateType<const IGPUBuffer *>("const IGPUBuffer *")));
arguments.Add(MethodArgument("inShaderStages", ReflectionSystem::GetOrCreateType<vk::Flags<vk::ShaderStageFlagBits>>("vk::Flags<vk::ShaderStageFlagBits>")));
arguments.Add(MethodArgument("inBindingIndex", ReflectionSystem::GetOrCreateType<unsigned int>("unsigned int")));
arguments.Add(MethodArgument("inDescriptorType", ReflectionSystem::GetOrCreateType<vk::DescriptorType>("vk::DescriptorType")));
arguments.Add(MethodArgument("inAccessFlags", ReflectionSystem::GetOrCreateType<vk::Flags<vk::AccessFlagBits>>("vk::Flags<vk::AccessFlagBits>")));
...
const vk::Flags<vk::ShaderStageFlagBits>& arg3 = *(const vk::Flags<vk::ShaderStageFlagBits>*)inArguments[3];
vk::Flags<vk::AccessFlagBits>& arg4 = *(vk::Flags<vk::AccessFlagBits>*)inArguments[4];
const vk::ImageLayout& arg5 = *(const vk::ImageLayout*)inArguments[5];
instance->BindImage(arg0, arg1, arg2, arg3, arg4, arg5);
return nullptr;
});
List<MethodArgument> arguments{};
...
{
VulkanDescriptorSet* instance = static_cast<VulkanDescriptorSet*>(inInstance);
const List<ResourceUsage> & result = instance->GetResourceUsages();
return (void*)&result;
});
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("GetResourceUsages", ReflectionSystem::GetOrCreateType<const List<ResourceUsage> &>("const List<ResourceUsage> &"), invoker, arguments));
}
}
{ 
...
{ 
	...
	{
		Field& currentField = currentClass->AddField(Field("mySubresourceRange", -1, ReflectionSystem::GetOrCreateType<vk::ImageSubresourceRange>("vk::ImageSubresourceRange"), false, false));
	}
	{
...
{
VulkanImage* instance = static_cast<VulkanImage*>(inInstance);
vk::Image& arg0 = *(vk::Image*)inArguments[0];
vk::Format& arg1 = *(vk::Format*)inArguments[1];
VulkanImage * result = instance->CreateFromSwapchainImage(arg0, arg1);
return (void*)result;
});
List<MethodArgument> arguments{};
arguments.Add(MethodArgument("inImage", ReflectionSystem::GetOrCreateType<vk::Image>("vk::Image")));
arguments.Add(MethodArgument("inFormat", ReflectionSystem::GetOrCreateType<vk::Format>("vk::Format")));
Method& currentMethod = currentClass->AddMethod(Method("CreateFromSwapchainImage", ReflectionSystem::GetOrCreateType<VulkanImage *>("VulkanImage *"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
VulkanImage* instance = static_cast<VulkanImage*>(inInstance);
VulkanImage * arg0 = (VulkanImage*)inArguments[0];
instance->DestroySwapchainImage(arg0);
return nullptr;
});
List<MethodArgument> arguments{};
arguments.Add(MethodArgument("inImage", ReflectionSystem::GetOrCreateType<VulkanImage *>("VulkanImage *")));
Method& currentMethod = currentClass->AddMethod(Method("DestroySwapchainImage", ReflectionSystem::GetOrCreateType<void>("void"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
...
{
VulkanImage* instance = static_cast<VulkanImage*>(inInstance);
static thread_local vk::ImageSubresourceRange result = instance->GetSubresourceRange();
return (void*)&result;
});
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("GetSubresourceRange", ReflectionSystem::GetOrCreateType<vk::ImageSubresourceRange>("vk::ImageSubresourceRange"), invoker, arguments));
}
}
{ 
