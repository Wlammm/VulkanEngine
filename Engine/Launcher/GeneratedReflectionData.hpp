...
{ 
	...
	{
		Field& currentField = currentClass->AddField(Field("myDescriptorSets", 96, ReflectionSystem::GetOrCreateType<List<vk::DescriptorSet>>("List<vk::DescriptorSet>"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("mySampler", 120, ReflectionSystem::GetOrCreateType<vk::Sampler>("vk::Sampler"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myP0", 128, ReflectionSystem::GetOrCreateType<ImVec2>("ImVec2"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myP1", 136, ReflectionSystem::GetOrCreateType<ImVec2>("ImVec2"), false, false));
	}
	currentClass->AddBaseType(ReflectionSystem::GetMutableType<EditorWindow>());
...
{ 
	Type* currentClass = ReflectionSystem::GetMutableType<IComponentArray>();
}
{ 
...
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("IsRenderStateDirty", ReflectionSystem::GetOrCreateType<bool>("bool"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
...
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("ResetRenderStateDirtyFlag", ReflectionSystem::GetOrCreateType<void>("void"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
...
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("GetComponents", ReflectionSystem::GetOrCreateType<List<Component *>>("List<Component *>"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
...
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("MarkPhysicsStateDirty", ReflectionSystem::GetOrCreateType<void>("void"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
...
List<MethodArgument> arguments{};
arguments.Add(MethodArgument("inComponent", ReflectionSystem::GetOrCreateType<Component *>("Component *")));
Method& currentMethod = currentClass->AddMethod(Method("OnComponentAdded", ReflectionSystem::GetOrCreateType<void>("void"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
...
List<MethodArgument> arguments{};
arguments.Add(MethodArgument("inComponent", ReflectionSystem::GetOrCreateType<Component *>("Component *")));
Method& currentMethod = currentClass->AddMethod(Method("OnComponentRemoved", ReflectionSystem::GetOrCreateType<void>("void"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
...
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("CreateUploadCommandBuffer_TS", ReflectionSystem::GetOrCreateType<vk::CommandBuffer>("vk::CommandBuffer"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
...
List<MethodArgument> arguments{};
arguments.Add(MethodArgument("commandBuffer", ReflectionSystem::GetOrCreateType<vk::CommandBuffer>("vk::CommandBuffer")));
...
{ 
	Type* currentClass = ReflectionSystem::GetMutableType<MulticastDelegate<void (Component *)>>();
	currentClass->AddTemplateArgument(ReflectionSystem::GetOrCreateType<void (Component *)>("void (Component *)"), false, false);
}
{ 
...
List<MethodArgument> arguments{};
arguments.Add(MethodArgument("inWorld", ReflectionSystem::GetOrCreateType<World *>("World *")));
...
{ 
	...
	{
		Field& currentField = currentClass->AddField(Field("myDefaultErrorCallback", 40, ReflectionSystem::GetOrCreateType<physx::PxErrorCallback>("physx::PxErrorCallback"), true, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myDefaultAllocator", 48, ReflectionSystem::GetOrCreateType<physx::PxDefaultAllocator>("physx::PxDefaultAllocator"), true, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myToleranceScale", 56, ReflectionSystem::GetOrCreateType<physx::PxTolerancesScale>("physx::PxTolerancesScale"), true, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myFoundation", 64, ReflectionSystem::GetOrCreateType<physx::PxFoundation>("physx::PxFoundation"), true, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myPvd", 72, ReflectionSystem::GetOrCreateType<physx::PxPvd>("physx::PxPvd"), true, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myPvdTransport", 80, ReflectionSystem::GetOrCreateType<physx::PxPvdTransport>("physx::PxPvdTransport"), true, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myDefaultMaterial", 88, ReflectionSystem::GetOrCreateType<physx::PxMaterial>("physx::PxMaterial"), true, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myListener", 96, ReflectionSystem::GetOrCreateType<PhysicsListener>("PhysicsListener"), true, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myPhysics", 104, ReflectionSystem::GetOrCreateType<physx::PxPhysics>("physx::PxPhysics"), true, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myScene", 112, ReflectionSystem::GetOrCreateType<physx::PxScene>("physx::PxScene"), true, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myControllerManager", 120, ReflectionSystem::GetOrCreateType<physx::PxControllerManager>("physx::PxControllerManager"), true, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myHasActiveSimulation", 128, ReflectionSystem::GetOrCreateType<bool>("bool"), false, false));
	}
	currentClass->AddBaseType(ReflectionSystem::GetMutableType<WorldSystem>());
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
...
{ 
	...
	{
		Field& currentField = currentClass->AddField(Field("myHitGameObject", 32, ReflectionSystem::GetOrCreateType<GameObject>("GameObject"), true, false));
	}
}
{ 
...
const List<Type *> & result = instance->GetAllClasses();
return (void*)&result;
});
List<MethodArgument> arguments{};
Method& currentMethod = currentClass->AddMethod(Method("GetAllClasses", ReflectionSystem::GetOrCreateType<const List<Type *> &>("const List<Type *> &"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
ReflectionSystem* instance = static_cast<ReflectionSystem*>(inInstance);
const std::basic_string<char> & arg0 = *(const std::basic_string<char>*)inArguments[0];
const Type * result = instance->GetClassByName(arg0);
return (void*)result;
});
List<MethodArgument> arguments{};
arguments.Add(MethodArgument("inName", ReflectionSystem::GetOrCreateType<const std::basic_string<char> &>("const std::basic_string<char> &")));
Method& currentMethod = currentClass->AddMethod(Method("GetClassByName", ReflectionSystem::GetOrCreateType<const Type *>("const Type *"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
ReflectionSystem* instance = static_cast<ReflectionSystem*>(inInstance);
const std::basic_string<char> & arg0 = *(const std::basic_string<char>*)inArguments[0];
const Type * result = instance->GetClassByFullName(arg0);
return (void*)result;
});
List<MethodArgument> arguments{};
...
Method& currentMethod = currentClass->AddMethod(Method("GetClassByFullName", ReflectionSystem::GetOrCreateType<const Type *>("const Type *"), invoker, arguments));
}
}
{ 
...
{ 
	...
	{
		Field& currentField = currentClass->AddField(Field("myCommandPoolsMutex", 40, ReflectionSystem::GetOrCreateType<std::recursive_mutex>("std::recursive_mutex"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myCommandPools", 120, ReflectionSystem::GetOrCreateType<std::map<std::thread::id, vk::CommandPool>>("std::map<std::thread::id, vk::CommandPool>"), false, false));
	}
	{
		Field& currentField = currentClass->AddField(Field("myComputeCommandPools", 144, ReflectionSystem::GetOrCreateType<std::map<std::thread::id, vk::CommandPool>>("std::map<std::thread::id, vk::CommandPool>"), false, false));
	}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
...
List<MethodArgument> arguments{};
arguments.Add(MethodArgument("inThreadId", ReflectionSystem::GetOrCreateType<const std::thread::id>("const std::thread::id")));
Method& currentMethod = currentClass->AddMethod(Method("GetCommandPoolForThread", ReflectionSystem::GetOrCreateType<vk::CommandPool>("vk::CommandPool"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
...
Method& currentMethod = currentClass->AddMethod(Method("CreateCommandBufferForThread", ReflectionSystem::GetOrCreateType<vk::CommandBuffer>("vk::CommandBuffer"), invoker, arguments));
}
{
Method::InvokerType invoker = Delegate<void*(void*, const List<void*>&)>([] (void* inInstance, const List<void*>& inArguments) -> void*
{
...
arguments.Add(MethodArgument("inThreadId", ReflectionSystem::GetOrCreateType<const std::thread::id>("const std::thread::id")));
arguments.Add(MethodArgument("inCommandBuffer", ReflectionSystem::GetOrCreateType<vk::CommandBuffer>("vk::CommandBuffer")));
Method& currentMethod = currentClass->AddMethod(Method("FlushCommandBufferFromThread", ReflectionSystem::GetOrCreateType<void>("void"), invoker, arguments));
}
}
{ 
